...
class IEH_Controller extends AbstractController
{
 ...
 {
 // Consulta para recuperar el primer mensaje de la tabla "secretosIEH"
 $sql = 'SELECT fraseIEH FROM secretosIEH LIMIT 1';
